<?php
/**
 * Admin new order email — Child theme override.
 *
 * Se envía al admin cuando se recibe un nuevo pedido.
 * Mantiene la estructura completa de WooCommerce para que los hooks
 * de estilos y CTA del child theme se ejecuten correctamente.
 *
...
<p>
	...
	echo wp_kses_post(
		sprintf(
			...
			__( 'You\'ve received the following order from %s:', 'woocommerce' ),
